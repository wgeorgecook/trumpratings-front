                ...
                <ul className="tweetMap">
                    { this.state.tweetInfo.map( (tweet, index) =>
                        <li key={index} className="tweetItem">
                            {(tweet.approval) ? <div className='approval'><span className='approveData'>{ tweet.approval }</span>% approving</div> : <div className='approval'>No approval data</div>}
                            {(tweet.disapproval) ? <div className='disapproval'><span className='disapproveData'>{ tweet.disapproval }</span>% disapproving</div> : <div className='disapproval'>No disapproval data</div>}
