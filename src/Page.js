                ...
                <ul className="tweetMap">
                    { this.state.tweetInfo.map( (tweet, index) =>
                        <li key={index} className="tweetItem">
                            {(tweet.approval) ? <div className='approval'><span className='pollData'>{ tweet.approval }%</span><div className="pollLabel">approving</div></div> : <div className='approval'>No approval data</div>}
                            {(tweet.disapproval) ? <div className='disapproval'><span className='pollData'>{ tweet.disapproval }%</span><div className="pollLabel">disapproving</div></div> : <div className='disapproval'>No disapproval data</div>}
